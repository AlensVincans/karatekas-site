...
export const dictionary = {
  ru: {
    ...
    heroText:
      "Кимоно, пояса, защита, перчатки и тренировочный инвентарь с понятными B2C/B2B ценами, доставкой по Балтии, курьером по ЕС и оплатой картой или по счёту.",
    ...
    delivery: "Доставка",
    deliveryText: "Omniva, DPD, Unisend, Latvijas Pasts в Балтии и курьерская доставка по ЕС.",
  ...
  lv: {
    ...
    heroText:
      "Kimono, jostas, aizsargi, cimdi un treniņu inventārs ar skaidrām B2C/B2B cenām, piegādi Baltijā, kurjeru ES un apmaksu ar karti vai rēķinu.",
    ...
    delivery: "Piegāde",
    deliveryText: "Omniva, DPD, Unisend, Latvijas Pasts Baltijā un kurjera piegāde ES.",
  ...
  en: {
    ...
    heroText:
      "Gi, belts, protection, gloves and training gear with clear B2C/B2B prices, Baltic delivery, EU courier delivery and card or invoice payment.",
    ...
    delivery: "Delivery",
    deliveryText: "Omniva, DPD, Unisend, Latvijas Pasts across the Baltics and EU courier delivery.",
  ...
  et: {
    ...
    heroText:
      "Gi, vööd, kaitsed, kindad ja treeningvarustus selgete B2C/B2B hindade, Balti tarne, ELi kulleri ning kaardi- või arvepõhise maksega.",
    ...
    delivery: "Tarne",
    deliveryText: "Omniva, DPD, Unisend, Latvijas Pasts Baltikumis ja kullerteenus ELis.",
  ...
  lt: {
    ...
    heroText:
      "Kimono, diržai, apsaugos, pirštinės ir treniruočių įranga su aiškiomis B2C/B2B kainomis, pristatymu Baltijos šalyse, kurjeriu ES ir apmokėjimu kortele arba pagal sąskaitą.",
    ...
    deliveryText: "Omniva, DPD, Unisend, Latvijas Pasts Baltijos šalyse ir kurjeris ES.",
